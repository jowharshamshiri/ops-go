...
// FailureClass is whose problem a failure is. The value is the stable
...
// FailureClassFromWire parses a wire token. Returns false for unknown
...
// (matches Rust FailureClass::from_wire)
